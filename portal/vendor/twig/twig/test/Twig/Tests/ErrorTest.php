...
EOHTML
        ...
        $template = $twig->loadTemplate('login_page#');
        try {
            $template->render(array());

            $this->fail();
        } catch (Twig_Error_Runtime $e) {
            $this->assertEquals('Variable "foo" does not exist in "login_page#" at line 3.', $e->getMessage());
            $this->assertEquals(3, $e->getTemplateLine());
            $this->assertEquals('login_page#', $e->getSourceContext()->getName());
        }
    }
...
EOHTML
        ...
        try {
            ...
            $this->assertEquals('An exception has been thrown during the rendering of a template ("Runtime error...") in "login_page#" at line 3.', $e->getMessage());
            $this->assertEquals(3, $e->getTemplateLine());
            $this->assertEquals('login_page#', $e->getSourceContext()->getName());
        }
    }
    ...
    public function testTwigExceptionGuessWithMissingVarAndFilesystemLoader()
    {
        ...
        try {
            ...
            $this->assertEquals(strtr(dirname(__FILE__).'/Fixtures/errors/login_page#', '/', DIRECTORY_SEPARATOR), $e->getFile());
        }
    }
