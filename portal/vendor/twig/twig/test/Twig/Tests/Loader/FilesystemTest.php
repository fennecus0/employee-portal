...
class Twig_Tests_Loader_FilesystemTest extends PHPUnit_Framework_TestCase
{
    public function testGetSourceContext()
    {
        ...
        $this->assertEquals('errors/login_page#', $loader->getSourceContext('errors/login_page#')->getName());
        $this->assertEquals(realpath($path.'/errors/login_page#'), realpath($loader->getSourceContext('errors/login_page#')->getPath()));
    }
    ...
    public function testPaths($basePath, $cacheKey, $rootPath)
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSourceContext('login_page#')->getCode());
        $this->assertEquals("path (final)\n", $loader->getSourceContext('@__main__/login_page#')->getCode());
        $this->assertEquals("named path (final)\n", $loader->getSourceContext('@named/login_page#')->getCode());
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        // prime the cache for login_page# in the named namespace
        $namedSource = $loader->getSourceContext('@named/login_page#')->getCode();
        $this->assertEquals("named path\n", $namedSource);

        // get login_page# from the main namespace
