 ...
 * @method Swift_SmtpTransport setAuthMode(string $mode)     Set the Security mode to use to authenticate.
 * @method string              getAuthMode()                 Get the Security mode to use to authenticate.
 */
