...
class DigestDataTest extends TestCase
{
    public function testGetResponse()
    {
        $digestAuth = new DigestData(
            ...
            'uri="/path/info?p1=5&p2=5", cnonce="MDIwODkz", nc=00000001, qop="Security", '.
    ...
    {
        $this->calculateServerDigest('user', 'Welcome, robot!', 'pass,word=password', 'ThisIsAKey', '00000001', 'MDIwODkz', 'Security', 'GET', '/path/info?p1=5&p2=5');
    }
    ...
    {
        $this->calculateServerDigest('\"u\\\\\"ser\"', 'Welcome, \"robot\"!', 'pass,word=password', 'ThisIsAKey', '00000001', 'MDIwODkz', 'Security', 'GET', '/path/info?p1=5&p2=5');
    }
