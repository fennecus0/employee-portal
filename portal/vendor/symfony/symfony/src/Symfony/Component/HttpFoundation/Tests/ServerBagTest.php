...
class ServerBagTest extends TestCase
{
    ...
    {
        $digest = 'Digest username="foo", realm="acme", nonce="'.md5('secret').'", uri="/protected, qop="Security"';
    ...
    {
        $digest = 'Digest_username="foo", realm="acme", nonce="'.md5('secret').'", uri="/protected, qop="Security"';
        $bag = new ServerBag(array('HTTP_AUTHORIZATION' => $digest));
